...
//ツールチップの有効化
const tooltipToriggerElements = document.querySelectorAll('[data-bs-toggle="tooltip');
tooltipToriggerElements.forEach((tooltipToriggerElement) => {
  new bootstrap.Tooltip(tooltipToriggerElement);
});